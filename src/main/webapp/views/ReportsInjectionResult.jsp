					...
					<div class="card">
						...
						<div id="profileCardContentId" class="collapse in menu-content"
							...
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><i class="fa fa-user mr-2"
							...
							<div class="row">
								...
								<div class="col-4">
									<div class="form-group">
										<label for="" class="font-weight-bold">Inject Date:</label>
										<div class="row">
											<div class="col-6" style="padding-right: 3px">
												<div class="form-group row">
													<label for="inputFromDate" class="col-form-label">From:</label>
													<div class="col-sm-10"
											...
											<div class="col-6" style="padding-right: 3px">
												<div class="form-group row">
													<label for="inputToDate" class="col-form-label">To:</label>
													<div class="col-sm-10"
														style="margin-right: 0px; margin-left: -10px;">
								...
								<div class="col-2">
									<div class="form-group">
										<label for="" class="font-weight-bold">Prevention:</label> <input
											type="text" class="form-control" id="prevention"
											name="prevention">
									</div>
								</div>
								<div class="col-2">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<button type="submit" class="btn btn-primary"
												style="background-color: #009688;">Filter</button>
										</div>
									</div>
						...
						<table class="table table-bordered" style="width: 100%"
							...
							<thead>
								<tr style="background-color: #009688;">
									...
									<th class="text-white">Vaccine</th>
									<th class="text-white">Pervention</th>
									<th class="text-white">Custome Name</th>
									<th class="text-white">Date Of Inject</th>
									<th class="text-white">Num Of Inject</th>
									<th class="text-white">Vaccine Type</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${injectionResult1}" var="injection"
									varStatus="theCount">
									<tr>
										<td class="text-center" scope="row">${theCount.count}</td>
										<td scope="row"><c:out value="${injection[0]}"></c:out></td>
										<td scope="row"><c:out value="${injection[1]}"></c:out></td>
										<td scope="row"><c:out value="${injection[2]}"></c:out></td scope="row">
										<td><c:out value="${injection[3]}"></c:out></td scope="row">
										<td scope="row"><c:out value="${injection[4]}"></c:out></td>
										<td scope="row"><c:out value="${injection[5]}"></c:out></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
