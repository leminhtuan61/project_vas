...
<body>
		...
		<div class="row main">
			...
			<section class="mainPage col-9" id="mainContent">
				...
				<div class="mt-3 mb-3 text-center">
					<h2>UPDATE INJECTION RESULT</h2>
				</div>
				<div class="card">
					<div class="card-body">
						<form:form method="post"
							action="${pageContext.request.contextPath}/injectionResult/update"
							modelAttribute="injectionResult" id="injectionUpdateForm">
							<div class="form-row">
								<div class="form-group col-md-4">
									<label class="font-weight-bold">Customer <span
										class="text-danger">(*)</span>
									</label>
									<form:hidden path="injectionResultId" />
									<form:select path="customer" class="form-control"
										itemLabel="Select the customer" disabled="true">
										<form:options items="${customers}" itemLabel="displayCustomer"
											itemValue="customerId" />
									</form:select>
									<input:hidden path="customer" />
								</div>
								<div class="form-group col-md-4">
									...
									<form:select id="inputPrevention"
										...
										onchange="filter()">
										<form:options items="${vaccineTypes}"
											itemValue="vaccineTypeName" itemLabel="vaccineTypeName" />
									</form:select>
								</div>
								<div class="form-group col-md-4">
									<label class="font-weight-bold">Vaccine name <span
										class="text-danger">(*)</span></label>
									<form:select path="vaccine" class="form-control">
										<form:options items="${vaccines}" itemValue="vaccineId"
							...
							<div class="form-row">
								<div class="form-group col-md-4">
									<label for="inputInjection" class="font-weight-bold">Injection
										<span class="text-danger">(*)</span>
									</label>
									<form:input path="numberOfInjection" id="inputInjection"
										class="form-control" />
									<form:errors path="numberOfInjection" cssClass="error" />
									<span id="injectionError" class="error" style="color: red"></span>
								</div>
								<div class="form-group col-md-4">
									<label for="dateOfInjection" class="font-weight-bold">Date
										of Injection</label>
									<form:input type="date" class="form-control"
										id="dateOfInjection" placeholder="" path="injectionDate" />
								</div>
								<div class="form-group col-md-4">
									<label for="nextInjection" class="font-weight-bold">Next
										Injection appointment</label>
									<form:input type="date" class="form-control" id="nextInjection"
										placeholder="" path="nextInjectionDate" />
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-4">
									<label class="font-weight-bold">Place of Injection<span
										class="text-danger">(*)</span></label>
									<form:select id="inputVaccineType" class="form-control"
												 path="injectionPlace">
										...
										<form:option
												value="Kona Community Hospital">Kona Community Hospital</form:option>
										<form:option
	...
	<script
			src="${pageContext.request.contextPath}/resources/js/injectionResultValidate.js"
			type="text/javascript"></script>
