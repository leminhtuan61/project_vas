...
<body>
					...
					<div class="card-body" style="padding-bottom: 0px">
						<form>
							<div class="row">
								...
								<div class="col-2">
									<div class="form-group">
										<label for="" class="font-weight-bold">Full name:</label> <input
								...
								<div class="col-2">
									<div class="form-group">
										<label for="" class="font-weight-bold">Address:</label> <input
						...
						<table class="table table-bordered" style="width: 100%"
							...
							<thead>
								<tr style="background-color: #009688;">
									...
									<th class="text-white">Number of Inject</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${customers}" var="customer"
									...
									<tr>
										...
										<td scope="row"><c:out value="${customer[0]}"></c:out></td>
										<td scope="row"><c:out value="${customer[1]}"></c:out></td>
										<td scope="row"><c:out value="${customer[2]}"></c:out></td scope="row">
										<td><c:out value="${customer[3]}"></c:out></td scope="row">
										<td scope="row"><c:out value="${customer[4]}"></c:out></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
	...
	<!-- Optional JavaScript -->
	<script
		src="${pageContext.request.contextPath}/resources/js/reportCustomer.js"></script>
